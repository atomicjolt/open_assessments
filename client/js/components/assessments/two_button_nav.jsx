...
export default class TwoButtonNav extends React.Component{
  ...
  render(){
    ...
    //       onClick={this.props.checkAnswers}></Button>
    //   );
    ...
    debugger;
    const buttonState = this.props.primaryAction.buttonState;
    if(buttonState === PRIMARY_ACTION.SUBMIT){
      primaryButton = (
         <Button
    ...
    } else if(buttonState === PRIMARY_ACTION.NEXT) {
      primaryButton = (
        <Button
    ...
    } else if(buttonState === PRIMARY_ACTION.CHECK_ANSWERS) {
      primaryButton = (
        <Button
          buttonClass="c-btn c-btn--check-answer"
          buttonText={this.props.localizedStrings.checkAnswerButton}
    ...
    } else if(buttonState === PRIMARY_ACTION.SAVE_FILES) {
      primaryButton = (
        <Button
          buttonClass="c-btn c-btn--check-answer"
    ...
    } else if(buttonState === PRIMARY_ACTION.SAVE_ANSWERS) {
      primaryButton = (
        <Button
          buttonClass="c-btn c-btn--check-answer"
    ...
    } else if(buttonState === PRIMARY_ACTION.SPINNER){
      primaryButton = (
        <Button
