export default {
  te: {
    ...
    assessmentComplete: {
      complete: "క్విజ్ పూర్తి" // Text displayed when quiz is completed (Quiz Completed-క్విజ్ ముగిసింది)
    },
    twoButtonNav:{
      ...
      checkAnswerButton: "సమాధానాన్ని తనిఖీ", // Text displayed on next questions button,
      saveFileButton: "ఫైల్ సెవ్ు", // Text displayed on save file button ఫైల్ సెవ్ (ఫైల్ కాపాడుట)
      saveAnswerButton: "జవాబు సేవ్", // Text displayed on save answer button జవాబు సేవ్(జవాబు కాపాడుట)
      submitButton: "క్విజ్ ముగింపు" // Text displayed on submit button క్విజ్ ముగింపు(క్విజ్ సమాప్తం)
    },
    item:{
    ...
    loading: {
      loading: "లొడ్ అయ్తవుంది/ లోడ్ అవ్తుంది"
    },
    audioUpload: {
      record: "రికార్డు",
      stop: "ఆపు/ఆగు"
