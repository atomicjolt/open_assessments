...
describe('item result', () => {
  ...
  var Subject = (<ItemResult settings={{}} question={question} isCorrect confidence={'Just A Guess'} />);
  var result = TestUtils.renderIntoDocument(Subject);

  it('renders the Item result with correct answer', () => {
  ...
  it('renders the Item result with incorrect answer', () => {
