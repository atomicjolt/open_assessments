...
class CheckButton extends React.Component {
  ...
  static propTypes = {
    ...
    questionResults: React.PropTypes.object,
    isCheckingAnswer: React.PropTypes.bool,
    ...
    unlockNext: React.PropTypes.string,
    checkButtonText: React.PropTypes.string,
  };
  ...
  render() {
    ...
    return (
      <Button
        buttonClass={`c-btn c-btn--check-answer ${extraClass}`}
