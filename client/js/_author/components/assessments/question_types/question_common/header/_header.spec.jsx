...
describe('header component', () => {
  ...
  it('displays the index number + 1', () => {
    const questionNumber = TestUtils.findRenderedDOMComponentWithClass(result, 'c-question__number');
  ...
  it('renders DefaultHeader when props.reorderActive is false', () => {
    const defaultHeader = TestUtils.findRenderedDOMComponentWithClass(result, 'c-question-icons');
    const reorderHeader = TestUtils.scryRenderedDOMComponentsWithClass(result, 'c-question-icons--reorder');
  ...
  it('renders ReorderHeader when props.reorderActive is true', () => {
    ...
    result = TestUtils.renderIntoDocument(<Stub><Header {...props} /></Stub>);
    const defaultHeader = TestUtils.findRenderedDOMComponentWithClass(result, 'c-question-icons');
    const reorderHeader = TestUtils.findRenderedDOMComponentWithClass(result, 'c-question-icons--reorder');
    expect(defaultHeader).toBeDefined();
